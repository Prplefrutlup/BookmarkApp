package com.prple.bookmark;

import com.prple.bookmark.constants.BookGenre;
import com.prple.bookmark.constants.Gender;
import com.prple.bookmark.constants.MovieGenre;
import com.prple.bookmark.constants.UserType;
import com.prple.bookmark.entities.Bookmark;
import com.prple.bookmark.entities.User;
import com.prple.bookmark.entities.UserBookmark;
import com.prple.bookmark.managers.BookmarkManager;
import com.prple.bookmark.managers.UserManager;
...
public class DataStore {
    ...
    private static void loadUsers() {
        users[0] = UserManager.getInstance().createUser(1000, "user0@prple.com", "test", "John","M", Gender.MALE, UserType.USER);
        users[1] = UserManager.getInstance().createUser(1001, "user1@prple.com", "test", "Sam","M", Gender.MALE, UserType.USER);
        users[2] = UserManager.getInstance().createUser(1002, "user2@prple.com", "test", "Katelyn", "K", Gender.FEMALE, UserType.EDITOR);
        users[3] = UserManager.getInstance().createUser(1003, "user3@prple.com", "test", "Buster", "B", Gender.MALE, UserType.EDITOR);
        users[4] = UserManager.getInstance().createUser(1004, "user4@prple.com", "test", "Corbin", "B", Gender.MALE, UserType.CHIEF_EDITOR);
    }
    ...
    private static void loadBooks() {
        ...
        bookmarks[2][4] = BookmarkManager.getInstance().createBook(4004, "Effective Java Programming Guide", 2007, "Prentice Hall", new String[] {"Joshua Bloch"}, BookGenre.TECHNICAL, 4.9);
